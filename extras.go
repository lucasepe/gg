...
func Arc(dc GraphicContext, x, y, r, angle1, angle2 float64) {
	dc.DrawEllipticalArc(x, y, r, r, angle1, angle2)
}

func Ellipse(dc GraphicContext, x, y, rx, ry float64) {
	dc.BeginPath()
	dc.DrawEllipticalArc(x, y, rx, ry, 0, 2*math.Pi)
	dc.ClosePath()
}

func Rect(dc GraphicContext, x, y, w, h float64) {
	dc.BeginPath()
	dc.MoveTo(x, y)
	dc.LineTo(x+w, y)
	dc.LineTo(x+w, y+h)
...
func RoundRect(dc GraphicContext, x, y, w, h, r float64) {
...
func RoundRectExtended(dc GraphicContext, x, y, w, h, tl, tr, br, bl float64) {
...
func Circle(dc GraphicContext, x, y, r float64) {
	dc.BeginPath()
	dc.DrawEllipticalArc(x, y, r, r, 0, 2*math.Pi)
	dc.ClosePath()
}

func Triangle(dc GraphicContext, x1, y1, x2, y2, x3, y3 float64) {
	dc.BeginPath()
	dc.MoveTo(x1, y1)
	dc.LineTo(x2, y2)
	dc.LineTo(x3, y3)
...
func RegularPolygon(dc GraphicContext, n int, x, y, r, rotation float64) {
...
func Quad(dc GraphicContext, x1, y1, x2, y2, x3, y3, x4, y4 float64) {
	dc.BeginPath()
	dc.MoveTo(x1, y1)
	dc.LineTo(x2, y2)
	dc.LineTo(x3, y3)
...
func Star(dc GraphicContext, cx, cy float64, spikes int, outerRadius, innerRadius float64) {
	rot := math.Pi / 2.0 * 3
...
func RotateAbout(dc GraphicContext, angle, x, y float64) {
	dc.Translate(x, y)
	dc.Rotate(angle)
	dc.Translate(-x, -y)
}
...
func ScaleAbout(dc GraphicContext, sx, sy, x, y float64) {
	dc.Translate(x, y)
	dc.Scale(sx, sy)
	dc.Translate(-x, -y)
}
...
func SetWorldCoordinates(dc GraphicContext, xMin, xMax, yMin, yMax float64, xOffset, yOffset float64) {

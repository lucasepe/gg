...
* DrawRoundedRectangle(x, y, w, h, tl, tr, bl, br float64)
* DrawQuad(x1, y1, x2, y2, x3, y3, x4, y4 float64)
DrawCircle(x, y, r float64)
DrawEllipse(x, y, rx, ry float64)
DrawEllipticalArc(x, y, rx, ry, angle1, angle2 float64)
DrawRegularPolygon(n int, x, y, r, rotation float64)
* DrawStar(cx, cy float64, spikes int, outerRadius, innerRadius float64)
